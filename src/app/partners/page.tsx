 ...
 * 반대로 이제 갈 곳이 **생긴** 자리(큐레이션 10곳·시장 1곳)는 전부 진짜 외부 링크다.
 *
 * ── 새 창 안내 (접근성 리뷰 P1-6) ────────────────────────────────────
...
/**
 * 실존 큐레이션 10곳 — 전부 `docs/partners-research.md` 에서 링크·취지를 검증했다.
 *
...
const CURATION: Group[] = [
  {
    ...
    places: [
      ...
      /*
       * 2026-08-17 추가 — 이 갈래에서 개인이 오늘 바로 주문할 수 있는 곳이 플립플라워
       * (정기구독 중심)뿐이라 비어 있던 자리다. 근거는 `docs/partners-research.md` A-4.
       * URL 은 한글 도메인(우리화원.com)의 퓨니코드다 — 보이는 대로 적으면 링크가 죽는다.
       */
      {
        key: 'wooriflower',
        where: '경기 부천 · 온라인',
        name: '우리화원',
        url: 'https://xn--oy2b11v1cz53e.com/',
        desc: '장애인표준사업장이에요. 장애인과 다문화가정 구성원이 함께 꽃다발과 화환을 만들어 전국으로 보내드려요.',
        caveat: '여느 꽃배달몰과 화면이 비슷해요 — 취지는 사이트 머리글의 표기로 확인했어요.',
      },
    ],
  },
  {
